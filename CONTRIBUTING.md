...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/Neural-Architecture-Search.git`
...
```bash
# Clone the repo
git clone https://github.com/Qyroxen/Neural-Architecture-Search.cd
